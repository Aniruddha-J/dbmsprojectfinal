...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> BMS Hospital</a>
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" id="list-profile-list"  href="previous.php" >Previous illness history</a>
      <a class="list-group-item list-group-item-action" id="list-profile-list"  href="prescription.php" >Prescription</a>
      ...
      <a class="list-group-item list-group-item-action" id="list-settings-list" href="output.php">History</a>
    </div><br>
  </div>
  <div class="col-md-8">
    <div class="tab-content" id="nav-tabContent">
      <div class="tab-pane fade show active" id="list-home" role="tabpanel" aria-labelledby="list-home-list">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <div style="text-align: center;"><h4>Create an appointment</h4></div><br>
                ...
                <div class="row">
                  ...
                  <div class="col-md-8">
                   <select name="doctor" class="form-control" >
                     ...
                     <option value="Dr. Dhoni<">Dr. Dhoni</option> 
                      <?php display_docs();?>
                    </select>
                  </div><br><br>
